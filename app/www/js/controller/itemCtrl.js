...
.controller('ItemCtrl', function($scope, $timeout, $ionicModal, $ionicPopup, $ionicPlatform, $cordovaBarcodeScanner, $ionicListDelegate, $ionicTabsDelegate, ItemServ) {
	$scope.items = [];
	...
	$scope.showDetails = function(group){
		...
		ItemServ.getByItemId(group._id.ItemID).then(function(res){
			$scope.thisGroup = res;
			$ionicModal.fromTemplateUrl('html/groupEdit.html', {
			  id:'editGroup',
			  scope: $scope,
